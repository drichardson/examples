...
- (void)setURLString:(NSString *)newURLString {
    if ((_urlString == nil) || ![_urlString isEqualToString:newURLString]) {
        [_urlString release];
...
- (void)setNotes:(NSString *)newNotes {
    if ((_notes == nil) || ![_notes isEqualToString:newNotes]) {
        [_notes release];
...
- (NSAttributedString *)attributedURLString {
    ...
    if (_urlString) {
        ...
        NSDictionary *attrs = [NSDictionary dictionaryWithObjectsAndKeys:
							   ...
							   [NSURL URLWithString:@"http://google.com"], NSLinkAttributeName,
