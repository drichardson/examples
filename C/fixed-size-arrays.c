...
int main(int argc, char const **argv)
{
	...
	char a4[4] = {1, 2, 4, 8};
	// printf("sum_3(a4) = %d\n", sum_3(a4)); // no compile time failure
	// here
	...
	// compile time error: incompatible pointer type printf("sum_4(&a3) =
	// %d\n", sum_4(&a3)); unsigned char u4[4] = { 1, 2, 4, 8}; compile time
	// error: incompatible pointer type printf("sum_4(&u4) = %d\n",
	// sum_4(&u4));
	...
	printf("a3[0] = %hhd (was passed by %s)\n",
	       a3[0],
	       a3[0] != a3_0_prev ? "reference" : "value");
